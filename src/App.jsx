...
import { ShieldCheck, Flame, Scissors, Building2, Mail, Phone, Download, Filter, ArrowRight, Factory, Layers3, Sparkles } from "lucide-react";

// ────────────────────────────────────────────────────────────────────────────────
// Artan Protec – One‑file React site
// TailwindCSS required. All sections in one component for easy drop‑in hosting.
// Brand line: "Advanced Protection. Engineered Performance."
// ────────────────────────────────────────────────────────────────────────────────
    ...
    <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b border-neutral-200">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-neutral-900 text-white grid place-items-center font-bold">AP</div>
          <div className="leading-tight">
            <h1 className="text-lg font-semibold tracking-tight">Artan Protec</h1>
            <p className="text-xs text-neutral-600">Advanced Protection. Engineered Performance.</p>
          </div>
        </div>
        ...
        <a href="#contact" className="hidden sm:inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-xl border border-neutral-300 hover:bg-neutral-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="#products" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-neutral-900 text-white text-sm font-semibold hover:bg-neutral-800">
              Explore Products <ArrowRight className="w-4 h-4" />
            </a>
            <a href="#contact" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl border border-neutral-300 text-sm font-semibold hover:bg-neutral-50">
              Request a Quote
            </a>
          </div>
          <div className="mt-8 flex items-center gap-6 text-sm text-neutral-600">
            <span className="inline-flex items-center gap-2"><ShieldCheck className="w-4 h-4"/> ISO‑grade QA</span>
            <span className="inline-flex items-center gap-2"><Building2 className="w-4 h-4"/> OEM & Private Label</span>
            <span className="inline-flex items-center gap-2"><Filter className="w-4 h-4"/> Lab‑tested specs</span>
          </div>
        </div>
        <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7 }} className="relative">
          <div className="aspect-[4/3] w-full rounded-3xl bg-[radial-gradient(ellipse_at_top_left,rgba(20,20,20,0.9),rgba(20,20,20,0.6),rgba(20,20,20,0.2))] shadow-2xl overflow-hidden grid place-items-center">
            <div className="text-center p-8">
              <div className="text-white/80 text-sm">Brand Suite</div>
              <div className="mt-2 text-white text-5xl font-black tracking-wider">ARTAN PROTEC</div>
              <div className="mt-2 text-white/80">Advanced Protection • Engineered Performance</div>
            </div>
          </div>
        </motion.div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {group.tags.map((t) => (
          <span key={t} className="px-2.5 py-1 rounded-full bg-neutral-100 text-neutral-700 text-xs border border-neutral-200">{t}</span>
        ))}
      </div>
    </motion.div>
  );
        ...
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-neutral-600 max-w-2xl">
              A focused portfolio spanning fibres, yarns, threads and technical fabrics—built to spec and
              delivered with traceability.
            </p>
          </div>
          <a href="#docs" className="hidden sm:inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-xl border border-neutral-300 hover:bg-white bg-neutral-100">
            <Download className="w-4 h-4"/> Download Datasheets
          </a>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div id="docs" className="mt-8">
          ...
          <div className="mt-3 flex flex-wrap gap-3">
            {DOCS.map((d)=> (
              <a key={d.label} href={d.href} className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-neutral-300 bg-white hover:bg-neutral-50 text-sm">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-8">
          <form className="rounded-2xl border border-neutral-200 bg-white p-6">
            <div className="grid sm:grid-cols-2 gap-4">
              <input required placeholder="Name" className="px-4 py-3 rounded-xl border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-900" />
              <input required type="email" placeholder="Email" className="px-4 py-3 rounded-xl border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-900" />
              <input placeholder="Company" className="px-4 py-3 rounded-xl border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-900 sm:col-span-2" />
              ...
              <textarea rows={4} placeholder="Message" className="px-4 py-3 rounded-xl border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-900 sm:col-span-2" />
            </div>
            <button type="submit" className="mt-4 inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-neutral-900 text-white text-sm font-semibold hover:bg-neutral-800">
              Send Message <ArrowRight className="w-4 h-4" />
            </button>
            <p className="mt-3 text-xs text-neutral-500">By submitting, you agree to our terms and privacy.</p>
          </form>
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-1 inline-flex items-center gap-2 text-neutral-700"><Phone className="w-4 h-4"/> +1 470 445 0578</div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-neutral-600">Advanced Protection. Engineered Performance.</div>
          </div>
        </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-neutral-600">
              {PRODUCT_GROUPS.slice(0,4).map((g)=> (
                <li key={g.key}><a href="#products">{g.title}</a></li>
              ))}
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-2 space-y-1 text-neutral-600">
              {DOCS.map((d)=> <li key={d.label}><a href="#docs">{d.label}</a></li>)}
            </ul>
          </div>
          <div>
        ...
        <div className="text-xs text-neutral-500">© {new Date().getFullYear()} Artan Protec. All rights reserved.</div>
      </div>
    </footer>
  );
}
